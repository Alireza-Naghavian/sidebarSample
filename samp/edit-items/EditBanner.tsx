import { ButtonBase, ButtonBaseProps, IconButton } from '@mui/material';
...
export default function EditBanner({
  ...
  return (
    <div className="group relative flex h-full w-full flex-col items-center gap-1 py-1">
      <div
        className={`h-full w-full text-center transition-[filter] duration-300 ${!showButtons && 'group-hover:blur-[2px]'} ${disableFilter && 'group-hover:!blur-[0px]'}`}
      >
        <ButtonBase
          ref={imageInputRef}
          component="label"
        ...
        >
          <Image
            loading="eager"
            alt="Upload new banner"
            src={avatarSrc || '/assets/images/vitaminet-logo.png'}
            parentProps={{
              sx: {
                '& img': {
                  objectFit: 'contain',
